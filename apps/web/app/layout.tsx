...
const themeBoot = `try{var d=document.documentElement,g=function(k){return localStorage.getItem(k)},t=g("ui-theme");if(t==="ledger"||t==="mono")d.dataset.theme=t;else delete d.dataset.theme;var a=g("ui-accent");if(a)d.dataset.accent=a;d.dataset.lightac=g("ui-light")==="gold"?"gold":"prism";var f=g("ui-font");if(f&&f!=="theme")d.dataset.font=f;var s=g("ui-size");if(s&&s!=="default")d.dataset.size=s;if(g("ui-convview")==="phone")d.dataset.convview="phone"}catch(e){}`;
