  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <button
        ...
        onClick={signIn}
        disabled={pending}
        className="glass flex items-center gap-2.5 rounded-lg px-5 py-2.5 text-[14px] font-semibold text-ink transition-colors hover:border-ledger disabled:opacity-60"
      >
