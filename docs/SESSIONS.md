...
| 9 | 17 Jul 2026 | Onboarding foundations — 0020 (signup holding fields, platform-scope events, stripe_events, first_light_predicates, activation/deletion doors), Barakah-branded signup pair outside the shell, fail-closed idempotent Stripe webhook, pre-active lifecycle on the existing cron (Resend platform mail), on branch `ui/s9-onboarding` (unmerged, awaiting click-review; live Supabase untouched) | `fa8dc4c`…`d705a23` | open — awaiting founder click-review + merge; rulings signed (DECISIONS 79–89) |
